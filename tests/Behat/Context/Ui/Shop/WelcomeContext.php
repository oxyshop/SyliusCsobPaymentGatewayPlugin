...
namespace Tests\MangoSylius\CsobPaymentGatewayPlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\MangoSylius\CsobPaymentGatewayPlugin\Behat\Page\Shop\WelcomePageInterface;
