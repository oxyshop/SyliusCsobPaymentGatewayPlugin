...
Feature: Adding a new payment method
	...
	@ui
	Scenario: Adding a new CSOB payment method
		Given I want to create a new payment method with "ČSOB" gateway factory
		When I name it "CSOB" in "English (United States)"
		And I specify its code as "csob"
		And I configure it with test CSOB credentials
		And I add it
		Then I should be notified that it has been successfully created
		And the payment method "CSOB" should appear in the registry
